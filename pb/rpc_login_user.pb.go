...
type LoginUserRsponse struct {
	...
	TrefreshToken         string               `protobuf:"bytes,4,opt,name=trefresh_token,json=trefreshToken,proto3" json:"trefresh_token,omitempty"`
...
func (x *LoginUserRsponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginUserRsponse) ProtoMessage() {}

func (x *LoginUserRsponse) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_login_user_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginUserRsponse.ProtoReflect.Descriptor instead.
func (*LoginUserRsponse) Descriptor() ([]byte, []int) {
	return file_rpc_login_user_proto_rawDescGZIP(), []int{1}
}

func (x *LoginUserRsponse) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *LoginUserRsponse) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *LoginUserRsponse) GetAccessToken() string {
	if x != nil {
...
func (x *LoginUserRsponse) GetTrefreshToken() string {
	if x != nil {
		return x.TrefreshToken
	}
	return ""
}

func (x *LoginUserRsponse) GetAccessTokenExpiresAt() *timestamp.Timestamp {
	if x != nil {
...
func (x *LoginUserRsponse) GetRefreshTokenExpiresAt() *timestamp.Timestamp {
	if x != nil {
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x64, 0x22, 0xc1, 0x02, 0x0a, 0x10, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1c, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72,
	...
	0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x25, 0x0a, 0x0e, 0x74, 0x72, 0x65, 0x66,
	0x72, 0x65, 0x73, 0x68, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0d, 0x74, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12,
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x6e, 0x64, 0x72, 0x65, 0x6d, 0x31, 0x39, 0x2f, 0x61,
	0x64, 0x76, 0x69, 0x63, 0x65, 0x6d, 0x65, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_rpc_login_user_proto_goTypes = []interface{}{
	...
	(*LoginUserRsponse)(nil),    // 1: pb.LoginUserRsponse
	(*User)(nil),                // 2: pb.User
	(*timestamp.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_rpc_login_user_proto_depIdxs = []int32{
	2, // 0: pb.LoginUserRsponse.user:type_name -> pb.User
	3, // 1: pb.LoginUserRsponse.access_token_expires_at:type_name -> google.protobuf.Timestamp
	3, // 2: pb.LoginUserRsponse.refresh_token_expires_at:type_name -> google.protobuf.Timestamp
